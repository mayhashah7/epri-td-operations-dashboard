# tdo-high-speed-recording

**Domain:** T&D Operations, Planning & Markets → phasor

**Mission:** PMU / DFR insights — fault localization & oscillations

## Background
Mines PMU and DFR records for fault localization, sub-synchronous oscillations, and protection-misoperation root cause.

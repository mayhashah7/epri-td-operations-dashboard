# tdo-ami-data-validation

**Domain:** T&D Operations, Planning & Markets → ami_validation

**Mission:** VEE pipeline w/ adaptive anomaly thresholds

## Background
Validation, estimation, editing on AMI streams. Identifies stuck registers, time skew, multi-meter mismatches, NTL-suggestive anomalies.

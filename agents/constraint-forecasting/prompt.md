# tdo-constraint-forecasting

**Domain:** T&D Operations, Planning & Markets → constraint

**Mission:** N-1 / N-1-1 contingency forecasts hour ahead

## Background
Probabilistic contingency analysis: forecasts congestion, voltage limits, thermal binding hour-ahead with uncertainty bands.
